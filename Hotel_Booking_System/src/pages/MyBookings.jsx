...
const MyBookings = () => {
    ...
    return (
        ...
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16'>
            ...
            <div className='max-q-6xl mt-8 w-full text-gray-800'>
                <div className='hidden md:grid md:grid-cols-[mfr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
